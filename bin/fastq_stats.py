...
def parse_args():
    parser = argparse.ArgumentParser(description="Generate FASTQ before/after stats")
    ...
    parser.add_argument("--min-mean-q", required=True)
...
def main():
    ...
    before = fastq_stats(input_fastq)
    after = fastq_stats(output_fastq)
    ...
    values = {
        ...
        "min_mean_q_threshold": args.min_mean_q,
